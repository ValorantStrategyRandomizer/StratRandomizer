...
const products = [
  ...
  {
    name: 'Team Comp Strategy Guide',
    description: 'Look up Specific Comps',
    href: '#',
    icon: CursorArrowRaysIcon,
  },
  {
    name: 'Lineup Guide',
    description: 'Become a Lineup Larry',
    href: '#',
    icon: FingerPrintIcon,
  },
  {
    name: 'Agent Specific Strategies',
    description: 'Master your agent and role',
    href: '#',
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3x shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
