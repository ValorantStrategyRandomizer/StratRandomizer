...
import RandomStrat, { findLengthAndReturnIndex, getRandomInt } from './strat';
...
const UnratedMapPool = [...CompetitiveMapPool, 'Bind', 'Breeze'];
const MapPool = {
  Competitive: {
    maps: [...CompetitiveMapPool],
  },
  Unrated: {
    maps: [...UnratedMapPool],
  },
...
const GameModes = ['Competitive', 'Unrated', 'Custom'];
...
export default function StrategyRandomizer() {
  ...
  const handleRandomMapClick = () => {
    ...
    const randomMap = findLengthAndReturnIndex(MapPool.Unrated.maps);
